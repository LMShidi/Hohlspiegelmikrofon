...
3.1.2 Reflextionsverhältnisse der verschiedenen Spiegelformen
...
3.1.3 Störwirkung von Multiquelle der Schall
...
Abb. Reflektionen des Spiegeles von Ebeneschallquelle mit einen Störpunktschallquelle  



3.1.4 Eine mögliche Verbesserung der Parabolspiegel
...
Es wird mit der Ebenen- und 3D-schallquelle zusammengefasst, wo der optimale Position der Mikrofon auf Brennpunkt des Spiegeles liegt, dass optimale Position der Mikrofon nicht auf Brennpunkt des Spiegeles festliegen soll, aber einbisschen nach Richtung bMAX verschieben wird. Noch wegen der Oberflächen des Mikrofones kann die optimale Position noch in Richtung bMAX geschiebt werden, damit der Mikrofon mehre reflektierende Schallwellen emfangen kann.(缺个图)


3.1.6 Wellenebenheit und Blendenzahl

Der Schall kann nur mit Medium verbreiten. Mit verschiedene Medium breitet der Schall nicht in der gleichen Geschwindigkeit aus. Here wird der Medium sich auf der Luft bezieht, da der Hohlspiegelmikrofon in der Luft genutzt wird. Die Schallgeschwindigkeit der Luft beschreibt wie schnell der Schall in der Luft verbreitet. Es ist stark abhängig von der Zustandsgrößen der Luft, zum Beispiel Dichte, Temperatur. In allgemein beträgt die Schallgeschwindigkeit der Luft bei Nomalbedingung (20°c) 343 m/s.(Zitat 3.6 Fahrzeugaukstik) 


Sofern die Zustand der Luft nicht geändert, bleibt die Schallgeschwindigkeit der Luft konstant. Unter diese Bedigung wird ein kugelformige Wellenebene der Schall durch ein Punktschallquelle erzeugt. Die Wellenebene wird immer flacher entlang der Verbreitungsweg der Schall. Ideal Fall mit keinen Energieverlust der Schallwellen wird die Wellenebene unendlich groß und echt platt. Darum wird der Spiegel einer geeignet Form gefordert um die Schallwellen fast gleichzeitig zu empfallen und reflektieren. Je ahnlicher der Spiegelform und der zugetroffenen Schallwellenebene ist, desto kleinere Abweichung davon entsteht. Die Wellenebenheit wird durch der Messabstand  und Spiegeldurchmesser gerechnet. Und der Parabolspiegelebene wird durch der Parabel-gleichung erzeugt. Um die Ähnlichkeit zwischen Schallwellenebene und der Spiegel zum Vergleichen, muss der Verhältnis von Brennweite zu Durchmesser,  auch Blendenzahl, des Parabolspiegeles erstmal berechnet werden.Der Verhältnis definiert der Krümmung des Spiegeles. Die Hohlspiegeln mit gemeinsamen Verhältnis verhaltet gleicherweise bei Reflektion der Schallwellen. Das optimal Wert für ein parabolischen Hohlspiegel liegt von 0.25 bis 0.65. Mit abnehmenden Blendenzahl wird der Spiegel noch krümmig. Das heißt, wenn der Messabstand klein ist, damit der Schallwelle noch nicht so platt ist, wird ein Parabolspiegel mit großer Blendenzahl eingesetzt. Umgekehrt geht das auch, bei großen Messabstand ist der Schallwelleneben flach, muss ein platter Parabolspiegel genutzt werden.(Zitat3-6)

3.1.7 Modell Festlegung(3.2Einführung)

Mit zusammenfassenden Grundungen,die in vorhergeschreibenen Kapitel geklärt werden, wird ein Modell der Hohlspiegelmikrofon  in fokusgespeiste, symmetrisch zur Achse ausgeleuchteten Parabolspiegel mit Parabolgleichung y=0.03x^2 entgeworfen. Der Durchmesser beträgt 200mm damit der Schallsignal mit alle Frequenz oberhalb 1715 Hz reflektierbar ist. Wobei der optimal Position für der Mikrofon entfernt 8.5mm auf der Spiegelscheitel, 0.2mm weg von der Spiegelbrennweite 8.3mm. Und dessen Blendzahl ist gleich 0.4, in vergleichen zu der Messabstand 2000mm ist der Aabweichung durch Wellenebenheit und Spiegelkrümmung vernachlässig.
